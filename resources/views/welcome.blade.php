    ...
    <div class="w-full max-w-4xl mx-auto p-4 sm:p-8 mt-6 sm:mt-10">
        <div class="bg-white rounded-lg shadow-lg p-6 sm:p-8 relative">
            ...
            <div class="flex flex-wrap items-center gap-4 mb-6">
                ...
                <div class="text-gray-600 text-sm">Trusted by 100k+ learners</div>
                <div class="text-gray-600 text-sm">4000+ placements</div>
            </div>

            <!-- Learn More Button -->
            <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg flex items-center transition duration-300">
