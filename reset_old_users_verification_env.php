 ...
 * This version reads database config from Laravel .env file
 * 
 * Upload this file to your cPanel public_html directory and run it via browser
 * URL: https://yourdomain.com/reset_old_users_verification_env.php
 */
...
<body>
    <div class="container">
        ...
        <div class="config">
            ...
            <p><em>If you get database connection errors, check your .env file or update the database credentials manually.</em></p>
        </div>
