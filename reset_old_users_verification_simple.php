<?php
/**
 * Simple PHP Script to Reset Mobile Verification for Old Users
 * This version doesn't require Laravel bootstrap - works with direct database connection
 * 
 * Upload this file to your cPanel public_html directory and run it via browser
 * URL: https://yourdomain.com/reset_old_users_verification_simple.php
 */
...
<body>
    <div class="container">
        ...
        <div class="config">
            ...
            <p><em>If you get database connection errors, update the database credentials at the top of this file.</em></p>
        </div>
